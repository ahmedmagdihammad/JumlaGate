                ...
                template: function(row) {
                    return '\
                        <div class="dropdown dropdown-inline">\
                            <a href="/dashboard/tags/' + row.id  + '" class="btn btn-sm btn-clean btn-icon mr-2" title="Show">\
                             \<i class="flaticon-eye"></i>\
                            </a>\
                        </div>\
                        <a href="/dashboard/tags/'+ row.id +'/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
