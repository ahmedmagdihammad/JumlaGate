                ...
                template: function(row) {
                    return '\
                        <div class="dropdown dropdown-inline">\
                            <a href="/dashboard/traders/' + row.id  + '" class="btn btn-sm btn-clean btn-icon mr-2" title="Show">\
                             \<i class="flaticon-eye"></i>\
                            </a>\
                        </div>\
                        <a href="/dashboard/traders/'+ row.id +'/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
