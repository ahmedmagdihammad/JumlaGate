                                ...
                                <div class="card product-card">
                                    <div class="card-body">
                                        <div class="product-thumbnail position-relative">
                                            ...
                                            <a href="{{route('showcategory.show', $category->category->id)}}">
                                                <img class="first-img" src="{{('factory_logos/'.$category->company->logo)}}" alt="thumbnail">
                                            </a>
                                            <!-- product links -->
                                        ...
                                        <div class="product-desc py-0">
                                            <h3 class="title"><a href="{{route('showcategory.show', $category->category->id)}}">{{$category->category->name_en}}</a></h3>
