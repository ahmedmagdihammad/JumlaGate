    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <form class="log-in-form" action="{{route('signin.create')}}" method="POST">
                    @csrf
                    <div class="form-group row">
                        <label for="staticEmail" class="col-md-3 col-form-label">Email</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="email" placeholder="email" name="email" autocomplete="on" value="{{ old('email') }}" >
                        </div>
                        @if ($errors->has('email'))
                    ...
                    <div class="form-group row text-center mb-0">
                        <div class="col-12">
                            <div class="border-top">
                                <a href="{{route('signup')}}" class="no-account">No account? Create one here</a>
                            </div>
                        </div>
                    </div>
                </form>
