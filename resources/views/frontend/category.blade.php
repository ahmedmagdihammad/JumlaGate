        ...
        <div class="row">
            ...
            <div class="col-12">
                <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
                    ...
                    <!-- <li class="breadcrumb-item"><a href="{{route('allcategories')}}">Categories</a></li> -->
                                        ...
                                        <div class="media flex-column flex-md-row">
                                            <div class="col-6">
                                                <div class="product-thumbnail position-relative">
                                                        ...
                                                        <span class="#">New</span>
                                                        <a href="{{route('allcategories.show', 1)}}">
                                                            <img class="first-img" src="{{asset('factory_logos/'.$product->img_1)}}" alt="thumbnail">
                                                        </a>
                                                    <!-- product links -->
                                                    <ul class="product-links d-flex justify-content-center">
                                            ...
                                            <div class="media-body pl-30">
                                                ...
                                                <button class="btn theme-btn--dark1 btn--xl rounded-{{$product->min_quantity}}"
                ...
                <aside class="left-sidebar theme1">
                    ...
                    <div class="search-filter">
                        <div class="check-box-inner mt-10">
                            ...
                            <form action="{{route('serchCatgeory')}}" method="get">
                            @csrf
                                <div class="filter-check-box">
                                    <input type="hidden" id="categoryid" name="categoryid" value="{{$categ->category_id}}">
                                    <input type="hidden" id="factoryid" name="factoryid" value="{{$id}}">
                                    <button type="submit">{{$categ->category['name_en']}}</button>
                                </div>
                            </form>
                            @endforeach
                        </div>
