                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h2 class="card-title">Edit Trader</h2>
                        </div>
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('dashboard.traders.update',$trader->id)}}" method = "POST">
                            @method('PUT')
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="mb-3">
                                    <div class="mb-2">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                <label>* Address :</label>
                                                <input type="text" name="address" class="form-control" value="{{old('address') ?? $trader->address}}" />
                                            ...
                                            <div class="col-lg-6">
                                                <label>* Phone :</label>
                                                <input type="number" name="phone" class="form-control" value="{{old('phone') ?? $trader->phone}}" />
                                                @if ($errors->has('phone'))
                                                    <div>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <a href="{{route('dashboard.traders.index')}}">
