            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('dashboard.categories.update',$category->id)}}" method ="POST">
                            @method('PUT')
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    <div class="mb-2">
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="name_en" class="form-control"  value="{{old('name_ar') ?? $category->name_en}}" />
