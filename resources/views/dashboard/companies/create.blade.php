                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h2 class="card-title">Add New Factory</h2>
                        </div>
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('dashboard.companies.store')}}" method = "POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="mb-3">
                                    <div class="mb-2">
                                        <label class="col-12 text-center mb-5">Upload Logo For The Factory</label>
                                        <div class="form-group row">
                                            <div class="col-12 text-center">
                                                <div class="image-input image-input-outline image-input-circle" id="kt_image">
                                                    <div class="image-input-wrapper" style="background-image: url({{asset('admin_assets/media/logos/logo.png')}})"></div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                <label>* Phone ( 1 ) :</label>
                                                <input type="number" name="phone_1" class="form-control" placeholder="Enter Phone Number ( 1 )" value="{{old('phone_1')}}" />
                                            ...
                                            <div class="col-lg-6">
                                                <label>* Phone ( 2 ) :</label>
                                                <input type="number" name="phone_2" class="form-control" placeholder="Enter Phone Number ( 2 )" value="{{old('phone_2')}}" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <label>* Owner :</label>
                                                <input type="text" name="owner" class="form-control" placeholder="Enter The owner Name" value="{{old('owner')}}" />
                                                @if ($errors->has('owner'))
                                                    <div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" id="kt_autosize" rows="1" name="brief" placeholder="Enter A Brief About The Factory">{{old('brief')}}</textarea>
                                                @if ($errors->has('brief'))
                                                    <div>
