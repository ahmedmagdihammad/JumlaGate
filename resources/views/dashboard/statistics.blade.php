    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
                ...
                <div class="alert-text">Interactive JavaScript Charts built on SVG. For more info please visit</div>
            </div>
            <!--end::Notice-->
            <div class="row">
                <div class="col-lg-6">
...
@push('scripts')
    ...
    <script src="{{asset('admin_assets/plugins/custom/flot/flot.bundle.js')}}"></script>
